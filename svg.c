...
void desenhaRetangulo(FILE *saida, double x, double y, double w, double h, char *corp, char *corb, char *rw){
     fprintf(saida, "<rect x=\"%lf\" y=\"%lf\" width=\"%lf\" height =\"%lf\" stroke=\"%s\"  fill=\"%s\" stroke-width=\"%s\"/>\n",
     x, y, w, h, corb, corp, rw);
}
